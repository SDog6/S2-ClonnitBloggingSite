...
<section class="credentials-container">
    ...
    <main>
        ...
        echo '<div class="left-title">  <h3> ' .
          $passedpost->Gettitle() .
          ' </h3> 
                     <p style="font-size:12px"> Posted by: ' .
          $user->GetUsername() .
          '</p>
                     </div> <br>';
        echo ' <div class="left-title">  <p> ' .
          $passedpost->Getcontent() .
          '</p> </div> <br>';
        ?>
        ...
        <section class="post-container">
            ...
            <?php if (isset($_SESSION['id'])) {
              echo ' <form action="post.php?var_id=' .
                $var_value .
                '" method="POST">
                        <textarea name="comment" placeholder="Comment...">' .
                htmlspecialchars($comment) .
                '</textarea><br>
                        <div class="error-msg-credentials">' .
                $errors['comment'] .
                '</div>
